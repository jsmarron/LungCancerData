...
Now we are ready to do the PCA. Note that we standardize the counts at each position as part of the PCA. The first visualization is the standard scree plot.

```{r,message=FALSE}
pca.out <- prcomp(rows_df, scale = TRUE)
fviz_eig(pca.out)
```
